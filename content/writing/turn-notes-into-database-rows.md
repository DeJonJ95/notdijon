...
![Cover (screenshot placeholder)](/writing/turn-notes-into-database-rows/00-cover.png)
...
![The 30-second pitch (gif placeholder)](/writing/turn-notes-into-database-rows/01-pitch.gif)
...
![Input step (screenshot placeholder)](/writing/turn-notes-into-database-rows/02-input-step.png)
...
![Source modes (gif placeholder)](/writing/turn-notes-into-database-rows/03-source-modes.gif)
...
![Database scope (screenshot placeholder)](/writing/turn-notes-into-database-rows/04-database-scope.png)
...
![Extracting (gif placeholder)](/writing/turn-notes-into-database-rows/05-extracting.gif)
...
![Preview list (screenshot placeholder)](/writing/turn-notes-into-database-rows/06-preview-list.png)
...
![Toggling changes (gif placeholder)](/writing/turn-notes-into-database-rows/07-toggling-changes.gif)
...
![Inline editing (gif placeholder)](/writing/turn-notes-into-database-rows/08-inline-editing.gif)
...
![Proposed columns (screenshot placeholder)](/writing/turn-notes-into-database-rows/09-proposed-columns.png)
...
![Done step (screenshot placeholder)](/writing/turn-notes-into-database-rows/10-done-step.png)

*The results step with a list of green success rows.*

![The payoff (screenshot placeholder)](/writing/turn-notes-into-database-rows/11-payoff.png)
...
![Architecture diagram (screenshot placeholder)](/writing/turn-notes-into-database-rows/12-architecture.png)
...
![The prompt (screenshot placeholder)](/writing/turn-notes-into-database-rows/13-prompt.png)
...
![Apply code (screenshot placeholder)](/writing/turn-notes-into-database-rows/14-apply-code.png)
...
![Before vs after (screenshot placeholder)](/writing/turn-notes-into-database-rows/15-before-after.png)
...
![Outro (gif placeholder)](/writing/turn-notes-into-database-rows/16-outro.gif)
...
![Call to action (screenshot placeholder)](/writing/turn-notes-into-database-rows/17-cta.png)
